...
import { SkeletonProperties } from '../data';

@Component({
  standalone: true,
  imports: [SharedModule],
  selector: 'assaf-documentation-skeleton-properties',
  templateUrl: './skeleton-properties.component.html',
  styleUrls: ['./skeleton-properties.component.scss'],
})
export class SkeletonPropertiesComponent implements OnInit {
  //#region Declerations
  ...
  get _properties() {
    return SortingTableProperties(SkeletonProperties);
  }
